    ...
    <nav className={styles["navbar-outer"]}>
      <div className={styles.Navbar}>
        <div className={styles.logo}>
          <img src="../assets/logo.svg" alt="Comfy Sloth Logo" />
        </div>
        <ul className={styles["navbar-center"]}>
        ...
        <div className={styles["cart-btn-wrapper"]}>
          <a className={styles["cart-btn"]} href="/cart">
            Cart
            <span className={styles["cart-container"]}>
              ...
              <span className={styles["cart-value"]}>6</span>
            </span>
          </a>
